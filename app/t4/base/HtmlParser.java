...
public class HtmlParser {
    ...
    private static final Pattern NOADD_INDEX = Pattern.compile(":eq|:lt|:gt|:first|:last|:not|:even|:odd|:has|:contains|:matches|:empty|^body$|^#");  // 不自动加eq下标索引
    ...
    public static String parseDomForUrl(String html, String rule, String add_url) {
        ...
        if (JSUtils.isNotEmpty(option)) {
            if (option.equals("Text")) {
                ...
                Elements original_ret = ret.clone();
